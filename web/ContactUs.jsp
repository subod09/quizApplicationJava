<%-- 
    Document   : ContactUs
    Created on : 10 Aug 2022, 11:41:03
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="AdminLogin.jsp">Examiner</a>
              </li>
              <li class="nav-item">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5">
                        <div class="map">
                            ...
                            <iframe src="https://maps.google.com/maps?q=lalitpur,dobighat&t=&z=13&ie=UTF8&iwloc=&output=embed" width="100%" height="350" frameborder="0" style="border: 0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
            ...
            <div class="row">
                 <div class="col-md-6">
                        <address>
                            ...
                            <br>
                            dobighat,lalitpur  <br>
                            nepal<br>
                            <abbr title="Telephone">T:</abbr> <a href="tel: +977-9860030719">+977-9860030719</a> <br>
                            <abbr title="Mail">M:</abbr><a href="mailto: info@subodh.com">info@subodh.com</a><br>
                        </address>
                </div>
                <div class="col-md-6">
                </div>
